...
const (
	Msg_Attest_FullMethodName       = "/dreamtree.attest.v1.Msg/Attest"
	Msg_UpdateParams_FullMethodName = "/dreamtree.attest.v1.Msg/UpdateParams"
)
